  ...
  Future<void> _verifyOtp() async {
    ...
    try {
      ...
      if (role == 'merchant') {
        ...
        setState(() {
          errorText =
              'This account is a merchant account. Please log in from the Merchant app.';
        });
        return;
      }
      ...
      if (role == 'customer') {
        ...
        setState(() {
          errorText =
              'This account is a customer account. Please log in from the Customer app.';
        });
        return;
      }

      throw Exception('Unsupported role for this app');
    } catch (e, st) {
