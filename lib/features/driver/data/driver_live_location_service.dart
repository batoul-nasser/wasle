...
class DriverLiveLocationService {
  ...
  Future<bool> startTracking({
    ...
    _timer?.cancel();
    if (syncImmediately) {
      await syncNow(driverId: driverId, requestPermissionIfNeeded: false);
    }

    _timer = Timer.periodic(pingInterval, (_) {
      syncNow(driverId: driverId, requestPermissionIfNeeded: false);
    });
  ...
  Future<Map<String, double>?> syncNow({
    ...
    final effectiveDriverId = driverId ?? _driverId;
